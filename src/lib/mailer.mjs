...
<body bgcolor="#0a0a0b" style="margin:0;padding:0;background:#0a0a0b;font-family:'Helvetica Neue',Arial,sans-serif;color:#e8e8ea;">
  <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#0a0a0b" style="background:#0a0a0b;padding:40px 0;">
    <tr><td align="center">
